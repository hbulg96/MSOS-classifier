...
def Single_File_Classification(input_path,
    ...
    return(average_zcr, sd_zcr, file_rms)
    ...
    for n in range(5):
        ...
        for x in range(300):
            ...
            if exact_file_index in previously_tested_file_indices:
                ...
                average_zcr, sd_zcr, file_rms = Single_File_Classification(input_path,
                                                               file_category,
                                                               rhythm_method,
                                                               spectral_centroid_method,
                                                                zero_crossing_rate_method)
...
##                print("Number of predictions correct = ", prediction_correct, " of ", n_index)
        ...
        print("Standard devs of ZCR = ", sd_zcrs)

        heatmap, xedges, yedges = numpy.histogram2d(average_rms, (sd_zcrs), bins=20)
