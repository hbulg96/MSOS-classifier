...
def Single_File_Classification(input_path,
    ...
    if test_method == True:
        ...
        cent = librosa.feature.spectral_centroid(input_file, sr=fs)

        S, phase = librosa.magphase(librosa.stft(input_file))
    ...
    feature_1_name = "Time spent with Min spectral contrast in noise band"
    feature_2_name = "Time spent with Max spectral contrast in feature band"

    print("Time spent with Min spectral contrast in noise band = ", feature_1)
    print("Time spent with max spectral contrast in feature band = ", feature_2) 
