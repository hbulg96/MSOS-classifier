...
def Single_File_Classification(input_path,
    ...
    if test_method == True:
        ...
        #feature_1 = sum(o_env)/len(o_env) # mean onset value
        #feature_2 = numpy.std(o_env)/feature_1 # coeff of variation of onset
        # Does Onset really just corellate with RMS?
        # is there a better metric we can use to show peaks of "harmonicity" and focus in on these??
        # maybe we could look at the number of notes onset peaks, and mean distance between them?
        #print("mean note onset = ", feature_1)
        #print("variation of note onset = ", feature_2)
        pass
    ...
    feature_1_name = "Note onset SD of peak crest factors"
    feature_2_name = "Note onset Mean of peak crest factors"
