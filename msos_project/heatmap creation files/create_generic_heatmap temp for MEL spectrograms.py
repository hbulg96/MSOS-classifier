...
def Single_File_Classification(input_path,
    ...
    if test_method == True:
        ...
        S = librosa.feature.melspectrogram(y=input_file, sr=fs,n_fft=(5096*8), n_mels=128,
                                    fmax=18000)
        ...
        print("Counter2 = ", counter2/unit_length)
        feature_1 =  1
        feature_2 =  2
        pass
    ...
    feature_2_name = "Feature band contrast coeff. of variation"
